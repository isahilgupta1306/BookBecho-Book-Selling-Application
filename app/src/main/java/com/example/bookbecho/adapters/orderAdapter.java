...
public class orderAdapter extends FirebaseRecyclerAdapter<productDataModel , orderAdapter.myViewHolder> {
     ...
     * @param options
     */
    public orderAdapter(@NonNull @NotNull FirebaseRecyclerOptions<productDataModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull @NotNull orderAdapter.myViewHolder holder, int position, @NonNull @NotNull productDataModel model) {
